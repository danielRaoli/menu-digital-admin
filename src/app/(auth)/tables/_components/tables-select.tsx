...
export default function TablesSelect({ onSelect, selectedTable }: TablesSelectProps) {
    ...
    return (
        ...
        >
            <ToggleGroupItem 
                className="data-[state=on]:bg-blue-600 cursor-pointer flex-auto max-w-min data-[state=on]:text-white px-4 py-2 rounded-md bg-gray-200 hover:bg-gray-200 transition-colors" 
                value="all"
            >
            ...
            {tables.map((table) => (
                <ToggleGroupItem  
                    className=" relative data-[state=on]:bg-blue-600 cursor-pointer flex-auto max-w-min data-[state=on]:text-white px-4 py-2 rounded-md bg-gray-200 hover:bg-gray-200 transition-colors" 
                    key={table.id} 
